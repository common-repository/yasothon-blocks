...
class PostsBlock extends Component {
	...
	render() {
        ...
        const { displayPostImage, displayCategoryList, titleFontSize, bodyFontSize, align, columns, order, orderBy, categories, postsToShow } = attributes;
		...
		return (
			<Fragment>
				...
				>
					...
					<div
						className={ classnames( [ 
							`content-post layout full style-2`
						] ) }
					>
