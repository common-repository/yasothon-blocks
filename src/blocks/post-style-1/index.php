 ...
 */
function yasothon_render_block_post_style_1( $attributes ) {
	...
	$grid_class = 'content-post grid layout style-1';
...
if ( ! function_exists( 'yasothon_register_block_post_style_1' ) ) :
	
	function yasothon_register_block_post_style_1() {
		...
		register_block_type( 'yasothon/yasothon-post-style-1', array(
			'attributes' => array(
				'categories' => array(
					'type' => 'string',
				),
			...
			'render_callback' => 'yasothon_render_block_post_style_1',
		) );
	}
endif;

add_action( 'init', 'yasothon_register_block_post_style_1' );
