...
class PostsBlock extends Component {
	...
	render() {
        ...
        const { displayCategoryList, titleFontSize, imageHeight,
            align, columns, order, orderBy, categories, postsToShow } = attributes;
							...
							>
							    {
									post.featured_image_src !== undefined && post.featured_image_src ? (
                                        <div class="text-inner" style={{ height: parseInt(imageHeight, 10) }}>
