 ...
 */
function yasothon_render_block_post_style_4( $attributes ) {
	...
	$grid_class = 'content-post layout full style-4';
...
/**
 * Registers the `yasothon/yasothon-post-stlye-1` block on server.
 */

if ( ! function_exists( 'yasothon_register_block_post_style_4' ) ) :
	
	function yasothon_register_block_post_style_4() {
		...
		register_block_type( 'yasothon/yasothon-post-style-4', array(
			'attributes' => array(
				'categories' => array(
					'type' => 'string',
				),
			...
			'render_callback' => 'yasothon_render_block_post_style_4',
		) );
	}
endif;

add_action( 'init', 'yasothon_register_block_post_style_4' );
