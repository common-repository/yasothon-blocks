 ...
 */
function yasothon_render_block_post_style_3( $attributes ) {
	...
	$grid_class = 'content-post layout grid style-3';
...
if ( ! function_exists( 'yasothon_register_block_post_style_3' ) ) :
	
	function yasothon_register_block_post_style_3() {
		...
		register_block_type( 'yasothon/yasothon-post-style-3', array(
			'attributes' => array(
				'categories' => array(
					'type' => 'string',
				),
			...
			'render_callback' => 'yasothon_render_block_post_style_3',
		) );
	}
endif;

add_action( 'init', 'yasothon_register_block_post_style_3' );
